#!/bin/bash
/data/redis/redis-stable/src/redis-server /home/workspace/redis/redis.conf > /home/workspace/redis/redis-startup.log 2>&1 &
...
sleep 120
/home/workspace/trucking-application/start.sh 2>&1 &
