...
zSetDecodedEntriesStreamingDF = zSetEntriesEncodedStreamingDF.withColumn("payment", unbase64(
    zSetEntriesEncodedStreamingDF.payment).cast("string"))
...
# this takes the stream and "sinks" it to the console as it is updated one message at a time (null means the JSON
# parsing didn't match the fields in the schema): {"reservationId":"9856743232","amount":"946.88"}
