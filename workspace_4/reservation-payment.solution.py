...
# this is a manually created schema - before Spark 3.0.0, schema inference is not automatic {
# "reservationId":"814840107","customerName":"Jim Harris", "truckNumber":"15867", "reservationDate":"Sep 29, 2020,
# 10:06:23 AM"}
...
zSetDecodedEntriesStreamingDF1 = zSetEntriesEncodedStreamingDF.withColumn("redisEvent", unbase64(
    zSetEntriesEncodedStreamingDF.redisEvent).cast("string"))
zSetDecodedEntriesStreamingDF2 = zSetEntriesEncodedStreamingDF.withColumn("redisEvent", unbase64(
    zSetEntriesEncodedStreamingDF.redisEvent).cast("string"))
...
paymentStreamingDF = spark.sql("select reservationId as paymentReservationId, amount as paymentAmount from Payment")
