...
java -Dconfig=/home/workspace/stedi-application/application.conf -jar /home/workspace/stedi-application/BankingSimulation-1.0-SNAPSHOT.jar > /home/workspace/stedi-application/stedi.log 2>&1 &
