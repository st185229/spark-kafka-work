...
vehicleStatusStreamingDF = vehicleStatusRawStreamingDF.selectExpr("cast(key as string) key",
...
# it is necessary for Kafka Data Frame to be readable, to cast each field from a binary to a string
vehicleCheckinStreamingDF = vehicleCheckinRawStreamingDF.selectExpr("cast(key as string) key",
                                                                    "cast(value as string) value")
